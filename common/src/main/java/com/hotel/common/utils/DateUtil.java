...
public class DateUtil {
   ...
   * @param endDate   结束时间
   * @param negative  是否允许输出负数,true 允许. false 不允许
   * @return Long
   * @date 2007-10-31
   */
  ...
  public static Date addMonth(Date start, int month) {
    Date nowDate = null;
    Calendar calendar = Calendar.getInstance();
  ...
  public static Map<String,Object> dateToWeek(Date datetime) {
